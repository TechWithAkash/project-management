...
import { changeCurrentPassword, forgotPasswordRequest, getCurrentUser, login, logoutUser, refreshAccessToken, registerUser, resendVerificationEmail, resetForgotPassword, verifyEmail } from "../controllers/auth.controllers.js";
...
router.route("/forgot-password").post(
    userForgotPasswordValidator(), validate,
